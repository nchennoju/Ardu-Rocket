...
int offset[4] = {-9, 7, -7, 0}; // 9, 10, 11, 12
...
//IMPORTANT! THIS IS WHERE YPR IS PRINTED
            ...
            if((int)((ypr[0] * 180/M_PI)) < -20){
              yawAmount = -20;
            }else if((int)(ypr[0] * 180/M_PI) > 20){
              yawAmount = 20;
            }else{
              yawAmount = (int)(ypr[0] * 180/M_PI);
            } 
            
            if((int)((ypr[1] * 180/M_PI)) < -90){
              pitchAmount = -90;
            }else if((int)(ypr[1] * 180/M_PI) > 90){
              pitchAmount = 90;
            }else{
              pitchAmount = (int)(ypr[1] * 180/M_PI);
            }

            if((int)((ypr[2] * 180/M_PI)) < -90){
              rollAmount = -90;
            }else if((int)(ypr[2] * 180/M_PI) > 90){
              rollAmount = 90;
            }else{
